"""A hello-world filter plugin in sshedmake_namespace_50.myrhdh_50."""
...
DOCUMENTATION = """
    name: hello_world
    author: Sshedmake_namespace_50 Myrhdh_50
    version_added: "1.0.0"
...
- name: Display a hello message
  ansible.builtin.debug:
    msg: "{{ 'ansible-creator' | sshedmake_namespace_50.myrhdh_50.hello_world }}"
"""
